...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 mt-10">
    ...
    <form action="index.php?url=register" method="POST">
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" name="username" type="text" placeholder="Tu nombre" required>
        </div>
        <div class="mb-4">
        ...
        <div class="flex items-center justify-between">
         ...
         <p class="text-center text-gray-500 text-xs mt-4">
            ¿Ya tienes cuenta? <a href="index.php?url=login" class="text-blue-600 hover:underline">Inicia Sesión</a>
        </p>
    </form>
</div>
